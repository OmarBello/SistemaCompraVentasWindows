...
namespace Sistema.Presentacion
{
    public partial class FrmPrincipal : Form
    {
        ...
        {
            StBarraInferior.Text = "Desarrollado por Mesa 8, Usuario: "+this.Nombre;
            MessageBox.Show("Bienvenido: " + this.Nombre, "Sistema de Sentas", MessageBoxButtons.OK, MessageBoxIcon.Information);
